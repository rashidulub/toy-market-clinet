...
const Details = () => {
    ...
    return (
        ...
        <div className="card-body">
            ...
            <p className="text-start text-2xl my-2 text-black">Price: $ 
             {price}</p>
            <p className="text-start text-2xl my-2 text-black">category:  {category}</p>
            <p className="text-start text-2xl my-2 text-black">  {details}</p>
